...
export default function Sidebar() {
  ...
  return (
    <aside className="w-56 bg-white border-r border-gray-200 fixed left-0 top-0 h-screen z-40 flex flex-col lg:flex hidden font-sans select-none">
      ...
      {/* QUICK ADD SECTION (Only visible to non-viewers) */}
      {!isViewer && (
        <div className="px-3 py-4 border-t border-gray-100 shrink-0">
          <span className="font-sans text-[10px] uppercase tracking-wider text-gray-500 font-bold block mb-2 px-1">
            Quick Add
          </span>
          <Link
