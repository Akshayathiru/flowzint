...
// Proxy to Voice Layer POST /callback/farmer — re-triggers for no_answer farmers in a pool
export async function POST(req: Request) {
  try {
    ...
    return NextResponse.json({ success: true, poolId: body.poolId ?? null, ...data })
  } catch (error) {
    console.error('Failed to retry callbacks:', error)
