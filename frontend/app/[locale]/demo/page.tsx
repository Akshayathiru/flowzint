...
export default function DemoControlPanelPage() {
  ...
  const triggerCallButtonRef = useRef<HTMLButtonElement>(null);
  ...
  const handleTriggerCall = () => {
    ...
    setTimeout(() => {
      ...
      // Move focus back to Trigger Call button after state transitions
      setTimeout(() => {
        triggerCallButtonRef.current?.focus();
      }, 50);
    }, 800);
  };
        ...
        <div className="bg-charcoal rounded-xl p-5 text-white shadow-sm">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              ...
              className="font-sans text-xs text-gray-500 hover:text-white transition-colors"
            >
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm hover:border-gray-300 transition-colors flex flex-col justify-between">
            <div>
              ...
              <div className="flex flex-col gap-3">
                <div>
                  <label className="font-sans text-[10px] uppercase tracking-wider text-gray-500 font-bold block mb-1">
                    Phone
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full border border-gray-200 rounded-lg px-3 py-2 font-sans text-sm focus:outline-none focus:ring-1 focus:ring-gray-300 bg-white text-charcoal disabled:opacity-60"
                  />
                </div>
                <div>
                  <label className="font-sans text-[10px] uppercase tracking-wider text-gray-500 font-bold block mb-1">
        ...
        <section className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm hover:border-gray-300 transition-colors flex flex-col min-h-[220px]">
          <div className="flex justify-between items-center mb-4 border-b border-gray-50 pb-3">
            ...
            {!isViewer && (
              <button
                onClick={handleResetAll}
                className="font-sans text-xs text-gray-500 hover:text-gray-600 transition-colors font-semibold"
              >
                Clear
              </button>
            )}
